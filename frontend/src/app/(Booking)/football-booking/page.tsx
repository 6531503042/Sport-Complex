              ...
              {slot?.map((lot) => (
                <div
                  ...
                  className={`border border-gray-200 rounded-lg p-6 shadow-md transition-transform duration-300 ease-in-out
                    ${lot.current_bookings ? "cursor-not-allowed bg-[#C1C7D4] text-white" : "cursor-pointer bg-[#5EB900] text-white border-green-300 hover:scale-105 hover:shadow-lg"}
                  ...
                  <div className="text-lg font-semibold flex justify-between items-center">
                    ...
                    <div>
                      {lot.current_bookings ? (
                        <ClearIcon className="mx-2.5" style={{ fontSize: "1.3rem" }} />
                      ) : (
                        <CheckIcon className="mx-2.5" style={{ fontSize: "1.3rem" }} />
                      )}
                    </div>
                  </div>
                </div>
