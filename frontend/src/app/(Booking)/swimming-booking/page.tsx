...
function Football() {
  const data: Data[] = [
    { time: "10.00 - 11.00", isAvailable: true, member: "0/30" },
    { time: "11.00 - 12.00", isAvailable: false, member: "30/30" },
    { time: "12.00 - 13.00", isAvailable: true, member: "0/30" },
    { time: "13.00 - 14.00", isAvailable: false, member: "30/30" },
    { time: "14.00 - 15.00", isAvailable: true, member: "0/30" },
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!hasErrors) {
      console.log("Form Booking successfully", formData);
    ...
    <>
      <div className="flex flex-col items-center h-screen p-6">
        <div className="w-full max-w-[1189px] bg-[#FEFFFE] border-gray border rounded-3xl drop-shadow-2xl p-5">
          <h1 className="text-4xl font-bold my-10 text-black text-center">Swimming Booking</h1>
